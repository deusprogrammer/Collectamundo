	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.accessories}">
				<li class="fieldcontain">
					<span id="accessories-label" class="property-label"><g:message code="user.accessories.label" default="Accessories" /></span>
					
						<g:each in="${userInstance.accessories}" var="a">
				...
				<g:if test="${userInstance?.consoles}">
				<li class="fieldcontain">
